...
<head>
	...
	<?php echo $this->Html->css('dist/css/skins/skin-blue.min.css') ?>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
					<?php echo $this->Html->link(__('Sign out'),['controller'=>'users','action' => 'logout'],array('class'=>'btn btn-default btn-flat'))?>
                </div>
              </li>
            </ul>
          </li>
